...
def federated_stream_artificial():
    ...
    # plt.ylim(0, 101)
    # plt.legend()
    # plt.savefig(f"./new-results/client_ks2samp_ED_ada_alp{alpha}_{test_name}_acc.png")
    # plt.show()
    #
    #
    # # 画全局正确率图
    ...
    # plt.grid(True)
    # plt.savefig(f"./new-results/global_ks2samp_ED_ada_alp{alpha}_{test_name}_acc.png")
    ...
    # 保存漂移点图
    plt.savefig(f"./new-results/driftp_ks2samp_ED_ada_alp{alpha}_{test_name}.png")
    plt.show()
    plt.pause(0.1)
...
if __name__ == "__main__":
    ...
    test_name = f"MD_incre_data_1.csv_g{global_epochs}_l{local_epoch}"
    drift_Flie_name = 'MD_incre_data'  # generated_hyperplane_data_2D_0.csv
